                    ...
                    <div class="form-validation">
                        <form class="form-valide" action="{{ url('/update_paket_kiloan/' . $id) }}" method="post" name="edit_paket_kiloan_form">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="val-hari" name="hari_paket" placeholder="Masukkan lama hari"  value="{{ $paket_kilos->hari_paket }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="val-minimal-berat" name="min_berat_paket" placeholder="Masukkan minimal berat paket"  value="{{ $paket_kilos->min_berat_paket }}">
                                        <div class="input-group-append">
