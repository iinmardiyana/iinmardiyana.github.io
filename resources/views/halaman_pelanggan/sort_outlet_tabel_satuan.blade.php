<table style="width: 100%;">
    @foreach($paketsatus as $paketsatus)
    <tr>
        ...
        <td style="width: 600px; font-weight: bold;" class="text-left item-satuan">
            {{ $paketsatus->nama_barang . ' ' . $paket_satu->ket_barang }}
            <input type="text" name="kd_barang[]" value="{{ $paketsatus->kd_barang }}" hidden="">
        </td>
        ...
        <td style="font-weight: bold; width: 200px; border-right: 1px solid #aaa;" class="item-satuan">
            Rp. {{ number_format($paketsatus->harga_barang,2,',','.') }}
            <input type="text" hidden="" name="harga_satuan" class="harga_satuan" value="{{ $paketsatus->harga_barang }}">
