@foreach($paketkilos as $paketkilo)
<div class="list-group-item flex-column align-items-start">
    <div class="d-flex w-100 justify-content-start">
        <h5 class="mb-2">{{ $paketkilo->nama_paket }}</h5>
    </div>
    <div class="row">
        <div class="col-md-6">
            <table style="width: 100%;" class="tabel-paket">
                <tr>
                    <td>Harga Paket</td>
                    <td>:</td>
                    <td>Rp. {{ number_format($paketkilo->harga_paket,2,',','.') }}</td>
                </tr>
                <tr>
                    <td>Lama Cuci</td>
                    <td>:</td>
                    <td>{{ $paketkilo->hari_paket }} Hari</td>
                </tr>
                <tr>
                    <td>Minimal Berat</td>
                    <td>:</td>
                    <td>{{ $paketkilo->min_berat_paket }} Kg</td>
                </tr>
            </table>
        </div>
        <div class="col-md-6">
        	@if($paketkilo->antar_jemput_paket == 1)
